...
, adptb_longlong_type   = {.size= sizeof(long long),          .align= sizeof(long long),          .kind= ADPT_KIND_LONGLONG  }
...
, adptb_ulonglong_type  = {.size= sizeof(unsigned long long), .align= sizeof(unsigned long long), .kind= ADPT_KIND_ULONGLONG }
